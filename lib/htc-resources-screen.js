  ...
  render() {
    return html`
      ...
      <div class="resources-wrap">
        ...
        ${this.renderCategory("Learning Paths", [
        ...
        ${this.renderCategory("HAX-Specific Tools", [
          ...
          { title: "HAX Design System", description: "DDD tokens, components, and patterns.", url: "https://github.com/haxtheweb/d-d-d" },
          { title: "Lit Documentation", description: "Web components library we use.", url: "https://lit.dev/" },
          { title: "Open WC Tooling", description: "Modern web component development.", url: "https://open-wc.org/" },
        ])}
        ${this.renderCategory("Community & Support", [
          ...
          { title: "Discord Community", description: "Ask questions and get help from members.", url: "https://discord.gg/PLACEHOLDER" },
