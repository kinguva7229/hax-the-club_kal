          ...
          <div class="testimonial-carousel">
            ...
            <div class="testimonial">
              <div class="testimonial-top">
                ...
                <div>
                  <p class="testimonial-name">Jordan K.</p>
                  <p class="testimonial-role">Frontend Intern @ Tech Company</p>
                </div>
              </div>
              <p class="testimonial-quote">"My commits in HAX were what got me the interview. Finally had real work to show."</p>
            </div>
